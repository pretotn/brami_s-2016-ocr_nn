...
public class START {
    ...
    public static String NEURAL_MAP_PATH = "./NeuralMapsFull/";
    ...
    private static void check(String path) {
        ...
        System.out.println(nn.check("input/dataset/alphabet/s.png"));
        System.out.println(nn.check("input/dataset/alphabet/a.png"));
        System.out.println(nn.check("input/dataset/alphabet/l.png"));
        System.out.println(nn.check("input/dataset/alphabet/u.png"));
        System.out.println(nn.check("input/dataset/alphabet/t.png"));
        System.out.println(nn.check("input/dataset/alphabet/a_small.png"));
        System.out.println(nn.check("input/dataset/alphabet/sym_num.png"));
    }
